import{products}from"./BV-data.js";
import{language}from"./BV-i8n.js";
let currentLanguage="en";
const root=document.getElementById("root");
const cartBrand = "bottega-veneta";setDirection();
render();
...
<a href="../pdp/pdp.html?brand=Bottega-Veneta&id=${product.id}">${lang.details}</a>
</div>
</div>
</article>`;
});
