import{products}from"./coach-data.js";
import{language}from"./coach-i18n.js";
let currentLanguage="en";
const root=document.getElementById("root");
const cartBrand = "coach";setDirection();
render();
...
<a href="../pdp/pdp.html?brand=Coach&id=${product.id}">${lang.details}</a>
</div>
</div>
</article>`;
});
