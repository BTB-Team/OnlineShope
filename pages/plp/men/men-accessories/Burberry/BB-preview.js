import{products}from"./BB-data.js";
import{language}from"./BB-i18n.js";
let currentLanguage="en";
const root=document.getElementById("root");
const cartBrand = "burberry";setDirection();
render();
...
<a href="../pdp/pdp.html?brand=Burberry&id=${product.id}">${lang.details}</a>
</div>
</div>
</article>`;
});
