import{products}from"./montblanc-data.js";
import{language}from"./montblanc-i18n.js";
let currentLanguage="en";
const root=document.getElementById("root");
const cartBrand = "montblanc";setDirection();
render();
...
<a href="../pdp/pdp.html?brand=Montblanc&id=${product.id}">${lang.details}</a>
</div>
</div>
</article>`;
});
