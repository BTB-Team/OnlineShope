import{products}from"./cartier-data.js";
import{language}from"./cartier-i18n.js";
let currentLanguage="en";
const root=document.getElementById("root");
const cartBrand = "cartier";setDirection();
render();
...
<a href="../pdp/pdp.html?brand=Cartier&id=${product.id}">${lang.details}</a>
</div>
</div>
</article>`;
});
