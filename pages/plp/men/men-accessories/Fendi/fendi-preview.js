import{products}from"./fendi-data.js";
import{language}from"./fendi-i18n.js";
let currentLanguage="en";
const root=document.getElementById("root");
const cartBrand = "fendi";setDirection();
render();
...
<a href="../pdp/pdp.html?brand=Fendi&id=${product.id}">${lang.details}</a>
</div>
</div>
</article>`;
});
