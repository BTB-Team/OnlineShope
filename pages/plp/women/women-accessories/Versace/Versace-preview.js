import{products}from"./Versace-data.js";
import{language}from"./Versace-i18n.js";
...
<a href="../pdp/pdp.html?brand=versace&id=${product.id}">${lang.details}</a>
</div>
</div>
</article>
`;
...
function getCart(){
try{
return JSON.parse(localStorage.getItem("cart_versace")||"[]");
}catch(error){
return[];
}
}
function saveCart(cart){
localStorage.setItem("cart_versace",JSON.stringify(cart));
}
