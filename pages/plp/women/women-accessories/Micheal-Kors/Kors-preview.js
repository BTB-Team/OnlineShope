import{products}from"./Kors-data.js";
import{language}from"./Kors-i18n.js";
...
<a href="../pdp/pdp.html?brand=michael-kors&id=${product.id}">${lang.details}</a>
</div>
</div>
</article>
`;
...
function getCart(){
try{
return JSON.parse(localStorage.getItem("cart_michael_kors")||"[]");
}catch(error){
return[];
}
}
function saveCart(cart){
localStorage.setItem("cart_michael_kors",JSON.stringify(cart));
}
