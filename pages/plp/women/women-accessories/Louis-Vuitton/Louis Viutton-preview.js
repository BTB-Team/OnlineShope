import{products}from"./Louis Vuitton-data.js";
import{language}from"./Louis Viutton-i18n.js";
...
<a href="../pdp/pdp.html?brand=louis-vuitton&id=${product.id}">${lang.details}</a>
</div>
</div>
</article>
`;
...
function getCart(){
try{
return JSON.parse(localStorage.getItem("cart_louis_vuitton")||"[]");
}catch(error){
return[];
}
}
function saveCart(cart){
localStorage.setItem("cart_louis_vuitton",JSON.stringify(cart));
}
