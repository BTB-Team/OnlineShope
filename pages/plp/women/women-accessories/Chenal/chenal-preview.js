import{products}from"./chenal-data.js";
import{language}from"./chenal-i18n.js";
let currentLanguage="en";
const root=document.getElementById("root");
const cartBrand="chanel";
setDirection();
render();
...
<a href="../pdp/pdp.html?brand=chanel&id=${product.id}">${lang.details}</a>
</div>
</div>
</article>`;
});
