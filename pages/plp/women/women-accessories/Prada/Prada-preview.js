import{products}from"./Prada-data.js";
import{language}from"./Prada-i18n.js";
...
<a href="../pdp/pdp.html?brand=prada&id=${product.id}">${lang.details}</a>
</div>
</div>
</article>
`;
...
function getCart(){
try{
return JSON.parse(localStorage.getItem("cart_prada")||"[]");
}catch(error){
return[];
}
}
function saveCart(cart){
localStorage.setItem("cart_prada",JSON.stringify(cart));
}
