/* ==========================================================
   IMPORTS
========================================================== */
import { perfumeSetsProducts } from "./Bu-fr-ps-data.js";
import translations from "./Bu-fr-ps-i18n.js";
...
const PRODUCT_TITLE_KEYS = {
    "bu-fr-ps-001": "diorPerfumeSet",
    "bu-fr-ps-002": "chanelPerfumeSet",
    "bu-fr-ps-003": "jadorePerfumeSet",
    "bu-fr-ps-004": "yslLibrePerfumeSet",
    "bu-fr-ps-005": "arianaGrandeCloudPerfumeSet",
    "bu-fr-ps-006": "marcJacobsPerfectPerfumeSet",
    "bu-fr-ps-007": "ninaRicciNinaPerfumeSet",
    "bu-fr-ps-008": "veraWangPrincessPerfumeSet"
};
...
let productList = perfumeSetsProducts;
...
let cartItems = JSON.parse(
    localStorage.getItem("perfumeSetsCart")
) || [];
...
const elements = {
    ...
    breadcrumbPerfumeSets: document.getElementById("breadcrumb-perfume-sets"),
...
function updateTexts() {
    ...
    elements.breadcrumbPerfumeSets.textContent =
        languageData.breadcrumbPerfumeSets;
...
function createProductCard(product) {
    ...
    <div class="product-card__content">
        ...
        <div class="product-card__details btn btn-ghost">
            <a href="../Beauty-fragrance-pdp/Bu-fragrance-pdp.html?id=${product.id}" class="product-card__details-link">
                ${currentLanguage === "fa"
