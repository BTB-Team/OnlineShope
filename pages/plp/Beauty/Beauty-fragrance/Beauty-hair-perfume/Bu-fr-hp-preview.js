/* ==========================================================
   IMPORTS
========================================================== */
import { hairPerfumeProducts } from "./Bu-fr-hp-data.js";
import translations from "./Bu-fr-hp-i18n.js";
...
const PRODUCT_TITLE_KEYS = {
    "bu-fr-hp-001": "chanelCocoMademoiselle",
    "bu-fr-hp-002": "gisouHoney",
    "bu-fr-hp-003": "diptyqueEauRose",
    "bu-fr-hp-004": "carolinaHerreraGoodGirl",
    "bu-fr-hp-005": "mfkBaccaratRouge540",
    "bu-fr-hp-006": "yslLibre",
    "bu-fr-hp-007": "yara",
    "bu-fr-hp-008": "kerastaseGlossAbsolu"
};
...
let productList = hairPerfumeProducts;
...
let cartItems = JSON.parse(
    localStorage.getItem("hairPerfumeCart")
) || [];
...
const elements = {
    ...
    breadcrumbHairPerfume: document.getElementById("breadcrumb-hair-perfume"),
...
function updateTexts() {
    ...
    elements.breadcrumbHairPerfume.textContent =
        languageData.breadcrumbHairPerfume;
