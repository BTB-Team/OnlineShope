/* ==========================================================
   IMPORTS
========================================================== */
import { perfumeProducts } from "./Bu-fr-pe-data.js";
import translations from "./Bu-fr-pe-i18n.js";
...
const PRODUCT_TITLE_KEYS = {
    "bu-fr-pe-001": "missDior",
    "bu-fr-pe-002": "chanelChance",
    "bu-fr-pe-003": "jadore",
    "bu-fr-pe-004": "libre",
    "bu-fr-pe-005": "goodGirl",
    "bu-fr-pe-006": "blackOpium",
    "bu-fr-pe-007": "laVieEstBelle",
    "bu-fr-pe-008": "burberryHer"
};
...
let productList = perfumeProducts;
...
let cartItems = JSON.parse(
    localStorage.getItem("perfumeCart")
) || [];
...
const elements = {
    ...
    breadcrumbPerfume: document.getElementById("breadcrumb-perfume"),
...
function updateTexts() {
    ...
    elements.breadcrumbPerfume.textContent =
        languageData.breadcrumbPerfume;
