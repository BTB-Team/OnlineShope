...
========================================================== */
import { bodyMistProducts } from "../Beauty-body-mist/Bu-fr-bm-data.js";
import { edpProducts } from "../Beauty-eau-de-parfum/Bu-fr-edp-data.js";
import { edtProducts } from "../Beauty-eau-de-toilette/Bu-fr-edt-data.js";
import { hairPerfumeProducts } from "../Beauty-hair-perfume/Bu-fr-hp-data.js";
import { perfumeProducts } from "../Beauty-perfume/Bu-fr-pe-data.js";
import { perfumeSetsProducts } from "../Beauty-perfume-sets/Bu-fr-ps-data.js";
import { solidPerfumeProducts } from "../Beauty-solid-perfume/Bu-fr-sp-data.js";
import { travelPerfumeProducts } from "../Beauty-travel-perfume/Bu-fr-tp-data.js";

/* ==========================================================
   PRODUCT TRANSLATIONS
========================================================== */
import bodyMistTranslations from "../Beauty-body-mist/Bu-fr-bm-i18n.js";
import edpTranslations from "../Beauty-eau-de-parfum/Bu-fr-edp-i18n.js";
import edtTranslations from "../Beauty-eau-de-toilette/Bu-fr-edt-i18n.js";
import hairPerfumeTranslations from "../Beauty-hair-perfume/Bu-fr-hp-i18n.js";
import perfumeTranslations from "../Beauty-perfume/Bu-fr-pe-i18n.js";
import perfumeSetsTranslations from "../Beauty-perfume-sets/Bu-fr-ps-i18n.js";
import solidPerfumeTranslations from "../Beauty-solid-perfume/Bu-fr-sp-i18n.js";
import travelPerfumeTranslations from "../Beauty-travel-perfume/Bu-fr-tp-i18n.js";

import translations from "./Bu-fragrance-pdp-i18n.js";
...
const CART_STORAGE_KEY = "beautyFragranceCart";
...
let productList = [
    ...
    ...perfumeProducts,
    ...perfumeSetsProducts,
    ...solidPerfumeProducts,
    ...travelPerfumeProducts
];
...
const PRODUCT_TRANSLATION_SOURCES = [
    {
        ...
        translations: bodyMistTranslations
    },
    {
        products: edpProducts,
        translations: edpTranslations
    },
    {
        products: edtProducts,
        translations: edtTranslations
    },
    {
        products: hairPerfumeProducts,
        translations: hairPerfumeTranslations
    },
    {
        products: perfumeProducts,
        translations: perfumeTranslations
    },
    {
        products: perfumeSetsProducts,
        translations: perfumeSetsTranslations
    },
    {
        products: solidPerfumeProducts,
        translations: solidPerfumeTranslations
    },
    {
        products: travelPerfumeProducts,
        translations: travelPerfumeTranslations
    }
];
...
function getCollectionBreadcrumb(product) {
    ...
    const collectionMap = {
        "Body Mist": { url: "../Beauty-body-mist/Bu-fr-body-mist.html" },
        "Eau de Parfum": { url: "../Beauty-eau-de-parfum/Bu-fr-edp.html" },
        "Eau de Toilette": { url: "../Beauty-eau-de-toilette/Bu-fr-edt.html" },
        "Hair Perfume": { url: "../Beauty-hair-perfume/Bu-fr-hair-perfume.html" },
        "Perfume": { url: "../Beauty-perfume/Bu-fr-perfume.html" },
        "Perfume Sets": { url: "../Beauty-perfume-sets/Bu-fr-perfume-sets.html" },
        "Solid Perfume": { url: "../Beauty-solid-perfume/Bu-fr-solid-perfume.html" },
        "Travel Perfume": { url: "../Beauty-travel-perfume/Bu-fr-travel-perfume.html" }
    };
    const collection =
        product.collection ||
        product.category ||
...
/* ==========================================================
   RENDER BREADCRUMB
   Home / Beauty-Fragrance / Collection / Product
========================================================== */
...
function renderCart() {
    ...
    cartItems.forEach(item => {
        ...
        const title =
            getProductTitle(product);
        const category =
            getLanguageData().beautyFragrance;
        const cartItem =
            document.createElement("div");
        cartItem.className =
            "cart-item";
