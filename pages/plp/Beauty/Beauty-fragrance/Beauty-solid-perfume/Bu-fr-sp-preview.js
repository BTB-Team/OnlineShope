/* ==========================================================
   IMPORTS
========================================================== */
import { solidPerfumeProducts } from "./Bu-fr-sp-data.js";
import translations from "./Bu-fr-sp-i18n.js";
...
const PRODUCT_TITLE_KEYS = {
    "bu-fr-sp-001": "missDior",
    "bu-fr-sp-002": "glossierYou",
    "bu-fr-sp-003": "diptyqueFleurDePeau",
    "bu-fr-sp-004": "fenty",
    "bu-fr-sp-005": "loccitaneShea",
    "bu-fr-sp-006": "lushRoseJam",
    "bu-fr-sp-007": "toccaLaila",
    "bu-fr-sp-008": "chloeAtelierDesFleurs"
};
...
let productList = solidPerfumeProducts;
...
let cartItems = JSON.parse(
    localStorage.getItem("solidPerfumeCart")
) || [];
...
const elements = {
    ...
    breadcrumbSolidPerfume: document.getElementById("breadcrumb-solid-perfume"),
...
function updateTexts() {
    ...
    elements.breadcrumbSolidPerfume.textContent =
        languageData.breadcrumbSolidPerfume;
