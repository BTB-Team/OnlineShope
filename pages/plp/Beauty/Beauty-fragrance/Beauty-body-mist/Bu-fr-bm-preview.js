/* ==========================================================
   IMPORTS
========================================================== */
import { bodyMistProducts } from "./Bu-fr-bm-data.js";
import translations from "./Bu-fr-bm-i18n.js";
...
const PRODUCT_TITLE_KEYS = {
    "bu-fr-bm-001": "cheirosa62",
    "bu-fr-bm-002": "bareVanilla",
    "bu-fr-bm-003": "bombshell",
    "bu-fr-bm-004": "pureSeduction",
    "bu-fr-bm-005": "loveSpell",
    "bu-fr-bm-006": "aThousandWishes",
    "bu-fr-bm-007": "intoTheNight",
    "bu-fr-bm-008": "warmVanillaSugar"
};
...
let productList = bodyMistProducts;
...
let cartItems = JSON.parse(
    localStorage.getItem("bodyMistCart")
) || [];
...
const elements = {
    ...
    breadcrumbBodyMist: document.getElementById("breadcrumb-body-mist"),
...
function updateTexts() {
    ...
    elements.breadcrumbBodyMist.textContent =
        languageData.breadcrumbBodyMist;
