/* ==========================================================
   IMPORTS
========================================================== */
import { travelPerfumeProducts } from "./Bu-fr-tp-data.js";
import translations from "./Bu-fr-tp-i18n.js";
...
const PRODUCT_TITLE_KEYS = {
    "bu-fr-tp-001": "chloeNomade",
    "bu-fr-tp-002": "diorJadore",
    "bu-fr-tp-003": "yslLibre",
    "bu-fr-tp-004": "gucciBloom",
    "bu-fr-tp-005": "pradaParadoxe",
    "bu-fr-tp-006": "carolinaHerreraGoodGirl",
    "bu-fr-tp-007": "burberryHer",
    "bu-fr-tp-008": "lancomeIdole"
};
...
let productList = travelPerfumeProducts;
...
let cartItems = JSON.parse(
    localStorage.getItem("travelPerfumeCart")
) || [];
...
const elements = {
    ...
    breadcrumbTravelPerfume: document.getElementById("breadcrumb-travel-perfume"),
...
function updateTexts() {
    ...
    elements.breadcrumbTravelPerfume.textContent =
        languageData.breadcrumbTravelPerfume;
