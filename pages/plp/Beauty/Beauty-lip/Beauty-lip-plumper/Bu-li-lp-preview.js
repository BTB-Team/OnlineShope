/* ==========================================================
   IMPORTS
========================================================== */
import { lipPlumperProducts } from "./Bu-li-lp-data.js";
import translations from "./Bu-li-lp-i18n.js";
...
const PRODUCT_TITLE_KEYS = {
    "bu-li-lp-001": "clearLipPlumper",
    "bu-li-lp-002": "plumpingLipTreatment",
    "bu-li-lp-003": "hydratingLipPlumper",
    "bu-li-lp-004": "glossyLipPlumper",
    "bu-li-lp-005": "tintedLipPlumper",
    "bu-li-lp-006": "shimmerLipPlumper",
    "bu-li-lp-007": "highShineLipPlumper",
    "bu-li-lp-008": "lipPlumpingGloss"
};
...
let productList = lipPlumperProducts;
...
let cartItems = JSON.parse(
    localStorage.getItem("lipPlumperCart")
) || [];
...
const elements = {
    ...
    breadcrumbLipPlumper: document.getElementById("breadcrumb-lip-plumper"),
...
function updateTexts() {
    ...
    elements.breadcrumbLipPlumper.textContent =
        languageData.breadcrumbLipPlumper;
