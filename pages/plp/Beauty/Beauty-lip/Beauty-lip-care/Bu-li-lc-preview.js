/* ==========================================================
   IMPORTS
========================================================== */
import { lipCareProducts } from "./Bu-li-lc-data.js";
import translations from "./Bu-li-lc-i18n.js";
...
const PRODUCT_TITLE_KEYS = {
    "bu-li-lc-001": "lipBalm",
    "bu-li-lc-002": "lipSleepingMask",
    "bu-li-lc-003": "lipScrub",
    "bu-li-lc-004": "lipOil",
    "bu-li-lc-005": "lipTreatment",
    "bu-li-lc-006": "lipMoisturizer",
    "bu-li-lc-007": "lipConditioner",
    "bu-li-lc-008": "lipRepairBalm"
};
...
let productList = lipCareProducts;
...
let cartItems = JSON.parse(
    localStorage.getItem("lipCareCart")
) || [];
...
const elements = {
    ...
    breadcrumbLipCare: document.getElementById("breadcrumb-lip-care"),
...
function updateTexts() {
    ...
    elements.breadcrumbLipCare.textContent =
        languageData.breadcrumbLipCare;
