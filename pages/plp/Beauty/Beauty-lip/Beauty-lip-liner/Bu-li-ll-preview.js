/* ==========================================================
   IMPORTS
========================================================== */
import { lipLinerProducts } from "./Bu-li-ll-data.js";
import translations from "./Bu-li-ll-i18n.js";
...
const PRODUCT_TITLE_KEYS = {
    "bu-li-ll-001": "classicLipLiner",
    "bu-li-ll-002": "retractableLipLiner",
    "bu-li-ll-003": "waterproofLipLiner",
    "bu-li-ll-004": "longWearLipLiner",
    "bu-li-ll-005": "nudeLipLiner",
    "bu-li-ll-006": "matteLipLiner",
    "bu-li-ll-007": "lipStainLiner",
    "bu-li-ll-008": "creamyLipLiner"
};
...
let productList = lipLinerProducts;
...
let cartItems = JSON.parse(
    localStorage.getItem("lipLinerCart")
) || [];
...
const elements = {
    ...
    breadcrumbLipLiner: document.getElementById("breadcrumb-lip-liner"),
...
function updateTexts() {
    ...
    elements.breadcrumbLipLiner.textContent =
        languageData.breadcrumbLipLiner;
