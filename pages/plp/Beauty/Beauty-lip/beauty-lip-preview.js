/* ==========================================================
   IMPORTS
========================================================== */
import { beautyLipData } from "./beauty-lip-data.js";
import translations from "./beauty-lip-i18n.js";
...
let categoryList = beautyLipData.categories;
...
function updatePageTexts() {
    ...
    elements.heroImage.src =
        beautyLipData.hero.image;
    elements.heroImage.alt =
        languageData[beautyLipData.hero.altKey];
