/* ==========================================================
   IMPORTS
========================================================== */
import { lipGlossProducts } from "./Bu-li-lg-data.js";
import translations from "./Bu-li-lg-i18n.js";
...
const PRODUCT_TITLE_KEYS = {
    "bu-li-lg-001": "clearLipGloss",
    "bu-li-lg-002": "tintedLipGloss",
    "bu-li-lg-003": "shimmerLipGloss",
    "bu-li-lg-004": "plumpingLipGloss",
    "bu-li-lg-005": "highShineLipGloss",
    "bu-li-lg-006": "hydratingLipGloss",
    "bu-li-lg-007": "glitterLipGloss",
    "bu-li-lg-008": "butterGloss"
};
...
let productList = lipGlossProducts;
...
let cartItems = JSON.parse(
    localStorage.getItem("lipGlossCart")
) || [];
...
const elements = {
    ...
    breadcrumbLipGloss: document.getElementById("breadcrumb-lip-gloss"),
...
function updateTexts() {
    ...
    elements.breadcrumbLipGloss.textContent =
        languageData.breadcrumbLipGloss;
