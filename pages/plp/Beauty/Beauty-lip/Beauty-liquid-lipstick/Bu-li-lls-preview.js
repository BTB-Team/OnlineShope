/* ==========================================================
   IMPORTS
========================================================== */
import { liquidLipstickProducts } from "./Bu-li-lls-data.js";
import translations from "./Bu-li-lls-i18n.js";
...
const PRODUCT_TITLE_KEYS = {
    "bu-li-lls-001": "matteLiquidLipstick",
    "bu-li-lls-002": "softMatteLiquidLipstick",
    "bu-li-lls-003": "velvetLiquidLipstick",
    "bu-li-lls-004": "satinLiquidLipstick",
    "bu-li-lls-005": "glossyLiquidLipstick",
    "bu-li-lls-006": "creamyLiquidLipstick",
    "bu-li-lls-007": "metallicLiquidLipstick",
    "bu-li-lls-008": "sheerLiquidLipstick"
};
...
let productList = liquidLipstickProducts;
...
let cartItems = JSON.parse(
    localStorage.getItem("liquidLipstickCart")
) || [];
...
const elements = {
    ...
    breadcrumbLiquidLipstick: document.getElementById("breadcrumb-liquid-lipstick"),
...
function updateTexts() {
    ...
    elements.breadcrumbLiquidLipstick.textContent =
        languageData.breadcrumbLiquidLipstick;
