/* ==========================================================
   IMPORTS
========================================================== */
import { lipSetsProducts } from "./Bu-li-lsets-data.js";
import translations from "./Bu-li-lsets-i18n.js";
...
const PRODUCT_TITLE_KEYS = {
    "bu-li-lsets-001": "lipstickSet",
    "bu-li-lsets-002": "liquidLipstickSet",
    "bu-li-lsets-003": "lipGlossSet",
    "bu-li-lsets-004": "lipLinerSet",
    "bu-li-lsets-005": "lipTintSet",
    "bu-li-lsets-006": "lipCareSet",
    "bu-li-lsets-007": "lipMakeupSet",
    "bu-li-lsets-008": "lipGiftSet"
};
...
let productList = lipSetsProducts;
...
let cartItems = JSON.parse(
    localStorage.getItem("lipSetsCart")
) || [];
...
const elements = {
    ...
    breadcrumbLipSets: document.getElementById("breadcrumb-lip-sets"),
...
function updateTexts() {
    ...
    elements.breadcrumbLipSets.textContent =
        languageData.breadcrumbLipSets;
