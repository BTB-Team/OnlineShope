/* ==========================================================
   IMPORTS
========================================================== */
import { lipstickProducts } from "./Bu-li-lipstick-data.js";
import translations from "./Bu-li-lipstick-i18n.js";
...
const PRODUCT_TITLE_KEYS = {
    "bu-li-ls-001": "matteLipstick",
    "bu-li-ls-002": "liquidLipstick",
    "bu-li-ls-003": "creamLipstick",
    "bu-li-ls-004": "satinLipstick",
    "bu-li-ls-005": "velvetLipstick",
    "bu-li-ls-006": "hydratingLipstick",
    "bu-li-ls-007": "glossyLipstick",
    "bu-li-ls-008": "lipCrayon"
};
...
let productList = lipstickProducts;
...
let cartItems = JSON.parse(
    localStorage.getItem("lipstickCart")
) || [];
...
const elements = {
    ...
    breadcrumbLipstick: document.getElementById("breadcrumb-lipstick"),
...
function updateTexts() {
    ...
    elements.breadcrumbLipstick.textContent =
        languageData.breadcrumbLipstick;
